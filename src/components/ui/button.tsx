...
const styles = {
  ...
  solid: [
    ...
    // darkers mode: border is rendered on `after` so background is set to button background
    'darkers:bg-[--btn-bg]',
    // Button background, implemented as foreground layer to stack on top of pseudo-border layer
    'before:absolute before:inset-0 before:-z-10 before:rounded-[calc(theme(borderRadius.lg)-1px)] before:bg-[--btn-bg]',
    // Drop shadow, applied to the inset `before` layer so it blends with the border
    'before:shadow',
    // Background color is moved to control and shadow is removed in darkers mode so hide `before` pseudo
    'darkers:before:hidden',
    // darkers mode: Subtle white outline is applied using a border
    'darkers:border-white/5',
    ...
    // darkers mode: `after` layer expands to cover entire button
    'darkers:after:-inset-px darkers:after:rounded-lg',
    // Disabled
  ...
  outline: [
    ...
    // darkers mode
    'darkers:border-white/15 darkers:text-white darkers:[--btn-bg:transparent] darkers:data-[active]:bg-white/5 darkers:data-[hover]:bg-white/5',
    // Icon
    '[--btn-icon:theme(colors.zinc.500)] data-[active]:[--btn-icon:theme(colors.zinc.700)] data-[hover]:[--btn-icon:theme(colors.zinc.700)] darkers:data-[active]:[--btn-icon:theme(colors.zinc.400)] darkers:data-[hover]:[--btn-icon:theme(colors.zinc.400)]',
  ],
  plain: [
    // Base
    'border-transparent text-zinc-950 data-[active]:bg-zinc-950/5 data-[hover]:bg-zinc-950/5',
    // darkers mode
    'darkers:text-white darkers:data-[active]:bg-white/10 darkers:data-[hover]:bg-white/10',
    // Icon
    '[--btn-icon:theme(colors.zinc.500)] data-[active]:[--btn-icon:theme(colors.zinc.700)] data-[hover]:[--btn-icon:theme(colors.zinc.700)] darkers:[--btn-icon:theme(colors.zinc.500)] darkers:data-[active]:[--btn-icon:theme(colors.zinc.400)] darkers:data-[hover]:[--btn-icon:theme(colors.zinc.400)]',
  ],
  colors: {
    'darkers/zinc': [
      'text-white [--btn-bg:theme(colors.zinc.900)] [--btn-border:theme(colors.zinc.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
      'darkers:text-white darkers:[--btn-bg:theme(colors.zinc.600)] darkers:[--btn-hover-overlay:theme(colors.white/5%)]',
    ...
    light: [
      ...
      'darkers:text-white darkers:[--btn-hover-overlay:theme(colors.white/5%)] darkers:[--btn-bg:theme(colors.zinc.800)]',
      '[--btn-icon:theme(colors.zinc.500)] data-[active]:[--btn-icon:theme(colors.zinc.700)] data-[hover]:[--btn-icon:theme(colors.zinc.700)] darkers:[--btn-icon:theme(colors.zinc.500)] darkers:data-[active]:[--btn-icon:theme(colors.zinc.400)] darkers:data-[hover]:[--btn-icon:theme(colors.zinc.400)]',
    ],
    'darkers/white': [
      'text-white [--btn-bg:theme(colors.zinc.900)] [--btn-border:theme(colors.zinc.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
      'darkers:text-zinc-950 darkers:[--btn-bg:white] darkers:[--btn-hover-overlay:theme(colors.zinc.950/5%)]',
      '[--btn-icon:theme(colors.zinc.400)] data-[active]:[--btn-icon:theme(colors.zinc.300)] data-[hover]:[--btn-icon:theme(colors.zinc.300)] darkers:[--btn-icon:theme(colors.zinc.500)] darkers:data-[active]:[--btn-icon:theme(colors.zinc.400)] darkers:data-[hover]:[--btn-icon:theme(colors.zinc.400)]',
    ],
    darkers: [
      'text-white [--btn-bg:theme(colors.zinc.900)] [--btn-border:theme(colors.zinc.950/90%)] [--btn-hover-overlay:theme(colors.white/10%)]',
      'darkers:[--btn-hover-overlay:theme(colors.white/5%)] darkers:[--btn-bg:theme(colors.zinc.800)]',
      '[--btn-icon:theme(colors.zinc.400)] data-[active]:[--btn-icon:theme(colors.zinc.300)] data-[hover]:[--btn-icon:theme(colors.zinc.300)]',
    ],
    white: [
      'text-zinc-950 [--btn-bg:white] [--btn-border:theme(colors.zinc.950/10%)] [--btn-hover-overlay:theme(colors.zinc.950/2.5%)] data-[active]:[--btn-border:theme(colors.zinc.950/15%)] data-[hover]:[--btn-border:theme(colors.zinc.950/15%)]',
      'darkers:[--btn-hover-overlay:theme(colors.zinc.950/5%)]',
    ...
    zinc: [
      ...
      'darkers:[--btn-hover-overlay:theme(colors.white/5%)]',
      '[--btn-icon:theme(colors.zinc.400)] data-[active]:[--btn-icon:theme(colors.zinc.300)] data-[hover]:[--btn-icon:theme(colors.zinc.300)]',
    ],
    indigo: [
...
export const Button = forwardRef(function Button(
  ...
  const classes = clsx(
    className,
    styles.base,
    outline ? styles.outline : plain ? styles.plain : clsx(styles.solid, styles.colors[color ?? 'darkers/zinc'])
  )
